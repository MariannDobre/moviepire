...
export default function UserStats() {
  ...
  if (!isAuthenticated) {
    return (
      <div className='w-full h-96 p-6 flex flex-col items-center justify-center gap-9 bg-neutral-50/10 border border-yellow-700 rounded-lg shadow-sm'>
  ...
  return (
    <div className='w-full h-auto p-6 flex flex-col gap-9 bg-neutral-50/10 border border-neutral-500 rounded-lg shadow-sm'>
